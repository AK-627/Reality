...
export default function AgentContactCard({
  ...
  return (
    <section aria-labelledby="agent-contact-heading">
      <h2 id="agent-contact-heading" className="text-xl font-semibold text-black mb-4">
        Contact Agent
      </h2>

      <div className="bg-grey-50 border border-grey-200 rounded-lg p-5 space-y-3">
        <p className="text-sm text-grey-600">
          Speak directly with our agent about this property.
        </p>

        <p className="text-sm font-medium text-black">{agentPhone}</p>
