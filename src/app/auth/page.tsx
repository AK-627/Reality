...
function RegisterForm({
  ...
  return (
    <form onSubmit={handleSubmit} noValidate className="space-y-4">
      ...
      <div>
        <label htmlFor="reg-name" className="block text-sm font-medium text-grey-700 mb-1">
          Full name
        </label>
        <input
          id="reg-name"
      ...
      <div>
        <label htmlFor="reg-email" className="block text-sm font-medium text-grey-700 mb-1">
          Email address
        </label>
        <input
          id="reg-email"
      ...
      <div>
        <label htmlFor="reg-password" className="block text-sm font-medium text-grey-700 mb-1">
          Password
        </label>
        <input
          id="reg-password"
      ...
      <div>
        <label htmlFor="reg-confirm" className="block text-sm font-medium text-grey-700 mb-1">
          Confirm password
        </label>
        <input
          id="reg-confirm"
      ...
      <div>
        <label htmlFor="reg-phone" className="block text-sm font-medium text-grey-700 mb-1">
          Phone number{" "}
          <span className="text-grey-400 font-normal">(optional — verify later for 1% discount)</span>
        </label>
        <input
          id="reg-phone"
          type="tel"
